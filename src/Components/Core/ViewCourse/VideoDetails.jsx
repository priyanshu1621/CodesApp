...
const VideoDetails = () => {
    ...
    const isFirstVideo = () => {
        ...
        console.log("Subsection: ", courseSectionData[currentSectionIndex].subSection)
                ...
                !videoData ? (<div>
                    ...
                    : (
                        <div className="max-w-full mx-auto">
                            <div className="aspect-w-16 aspect-h-9 min-w-[320px]">
                                <div className="max-w-7xl mx-auto my-8">
                                    <div className="aspect-w-16 aspect-h-9 w-full md:max-w-4xl lg:max-w-6xl">
                                        <Player
                                            ref={playerRef}
                                            playsInline
